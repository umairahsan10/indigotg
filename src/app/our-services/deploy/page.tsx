...
// Reveal Links Component for Deploy
const RevealLinks = () => {
  return (
  ...
  if (isHero) {
    ...
    return (
      ...
      >
        ...
        >
          Deploy, Install, Test and Optimise Infrastructure
        </motion.p>
      </motion.div>
    );
  }
...
export default function DeployServicesPage() {
  // No scroll-to-top effect - let the page behave naturally on reload

  return (
    <div className="bg-white">
      <TextParallaxContent
        imgUrl="/services/img-2.jpg"
        subheading="DEPLOY"
        heading="SERVICES"
        isHero={true}
      >
        ...
        <motion.div 
          ...
          className="mx-auto max-w-5xl px-4 pb-12 pt-12"
        >
          <h1 className="text-4xl font-bold text-blue-900 md:text-3xl lg:text-4xl text-center">
            We use all our expertise to tackle well-known bottlenecks
          </h1>
        </motion.div>
      ...
      {/* Services Section */}
      <ServicesSection defaultFilter="deploy" />
    </div>
  );
} 