    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative h-screen bg-gradient-to-r from-[#140079] to-blue-600">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-16 sm:h-20 md:h-24 lg:h-32 bg-gradient-to-t from-white via-white/80 to-transparent z-10"></div>
                
                <div className="relative z-10 h-full flex items-center">
                    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-8">
                        <div className="text-white">
                            ...
                            <div className="flex items-center text-white">
                                ...
                                <span className="text-lg sm:text-xl md:text-2xl font-medium tracking-wide">27 May 2024</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Article Content */}
            <main className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-8 py-8 sm:py-12 md:py-16">
                {/* Breadcrumb */}
                ...
                {/* Article Content */}
                <article className="prose prose-sm sm:prose-base md:prose-lg lg:prose-xl xl:prose-2xl max-w-none">
                    {/* Article Title */}
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#140079] mb-4 sm:mb-6 md:mb-8 leading-tight">
                        Keeping subsea cables connected
                    </h1>

                    {/* Author Section */}
                    <div className="mb-6 sm:mb-8">
                        <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#140079] mb-2 sm:mb-3">
                            By Kathy Kirchner, Network Operations VP for Americas
                        </h3>
                    </div>
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#140079] mb-4 sm:mb-6">Preventative ship tracking</h2>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#140079] mb-4 sm:mb-6">Timely fault fixing</h2>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6">
                    ...
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-6 sm:mb-8 md:mb-12">
