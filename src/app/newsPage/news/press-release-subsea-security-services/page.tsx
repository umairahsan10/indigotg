                    ...
                    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                        <div className="text-white">
                            ...
                            <div className="flex items-center text-white px-2 sm:px-0">
                                ...
                                <span className="text-lg sm:text-xl md:text-2xl font-medium tracking-wide">14 May 2024</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
                ...
                <article className="prose prose-sm sm:prose-base md:prose-lg lg:prose-xl max-w-none">
                    ...
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
                        <div className="flex-shrink-0">
                            <img 
                                ...
                                className="w-24 h-32 sm:w-32 sm:h-40 md:w-36 md:h-44 rounded-lg object-cover border-2 border-[#140079]/20"
                            />
                        </div>
                        <div className="flex-1 text-center sm:text-left sm:pt-2">
                            <h3 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">Ian Duggan, CEO of Indigo</h3>
                    ...
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
                        ...
                        <div className="flex-1 text-center sm:text-left sm:pt-2 md:pt-10">
                            <h3 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">William Rendle, Head of Information Security</h3>
                            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-gray-100 p-4 sm:p-6 rounded-lg mb-6 sm:mb-8">
                        <h3 className="text-lg sm:text-xl font-bold text-[#140079] mb-3 sm:mb-4">To find out more, please contact:</h3>
                        <div className="space-y-2 sm:space-y-3">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                                <FaEnvelope className="text-[#140079] text-base sm:text-lg flex-shrink-0" />
                                <span className="text-sm sm:text-base md:text-lg font-medium">Liz Edwards, Marketing and Communications Director</span>
                            </div>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                                <FaEnvelope className="text-[#140079] text-base sm:text-lg flex-shrink-0" />
                                <a href="mailto:liz.edwards@indigotg.com" className="text-sm sm:text-base md:text-lg text-[#140079] hover:underline break-all">
                                    liz.edwards@indigotg.com
                                </a>
                            </div>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                                <FaPhone className="text-[#140079] text-base sm:text-lg flex-shrink-0" />
                                <a href="tel:+353868171512" className="text-sm sm:text-base md:text-lg text-[#140079] hover:underline">
                                    +353 86 817 1512
                                </a>
                            </div>
                        </div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-[#140079] mb-3 sm:mb-4">About Indigo</h3>
                    <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-6 sm:mb-8">
                        Visit us at: <a href="https://www.indigotg.com" target="_blank" rel="noopener noreferrer" className="text-[#140079] hover:underline font-medium break-all">www.indigotg.com</a>
                    </p>
                    ...
                    <div className="text-center mb-8 sm:mb-12">
                        <a
                            ...
                            download
                            className="inline-flex items-center px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-[#140079] text-white rounded-lg hover:bg-[#0f0057] transition-all duration-300 ease-in-out hover:scale-105 shadow-lg text-sm sm:text-base"
                        >
                            <FaDownload className="mr-2 sm:mr-3 text-lg sm:text-xl" />
