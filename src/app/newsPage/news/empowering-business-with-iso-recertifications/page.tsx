...
export default function EmpoweringBusinessWithISORecertificationsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                        <div className="text-white">
                            ...
                            <div className="flex items-center text-white">
                                ...
                                <span className="text-lg sm:text-xl md:text-2xl font-medium tracking-wide">24 May 2024</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Article Content */}
            <main className="max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
                {/* Breadcrumb */}
                <nav className="text-gray-500 text-xs sm:text-sm mb-6 sm:mb-8">
                    ...
                    <span className="mx-2">•</span>
                    <span className="text-[#140079] break-words">Empowering Customers through ISO Recertifications</span>
                </nav>
                ...
                <article className="prose prose-sm sm:prose-base md:prose-lg lg:prose-xl max-w-none">
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
                        <div className="flex-shrink-0 w-full sm:w-auto">
                            <img 
                                ...
                                className="w-full max-w-[144px] sm:w-36 h-auto sm:h-44 rounded-lg object-cover border-2 border-[#140079]/20 mx-auto sm:mx-0"
                            />
                        </div>
                        <div className="flex-1 pt-0 sm:pt-2 text-center sm:text-left">
                            <h3 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">Dave Healy, Head of SHEQ</h3>
                    ...
                    {/* The Problem Section */}
                    <h3 className="text-xl sm:text-2xl font-bold text-[#140079] mb-3 sm:mb-4">The Problem: Navigating a Sea of Uncertainty</h3>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-[#140079] mb-3 sm:mb-4">Indigo's ISO Recertifications</h3>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6">
                    ...
                    <div className="my-6 sm:my-8">
                        ...
                        />
                        <p className="text-center text-gray-600 text-xs sm:text-sm mt-2 italic px-2">
                            Our dedicated team of professionals working together to maintain the highest standards
                        </p>
                    </div>

                    {/* ISO 9001 */}
                    <h4 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">ISO 9001: Quality Management Systems</h4>
                    ...
                    <ul className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6 space-y-1 sm:space-y-2 pl-4 sm:pl-6">
                    ...
                    {/* ISO 14001 */}
                    <h4 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">ISO 14001: Environmental Management Systems</h4>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-3 sm:mb-4">
                    ...
                    {/* ISO 27001 */}
                    <h4 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">ISO 27001: Information Security Management Systems</h4>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-3 sm:mb-4">
                    ...
                    {/* ISO 45001 */}
                    <h4 className="text-lg sm:text-xl font-bold text-[#140079] mb-2 sm:mb-3">ISO 45001: Occupational Health and Safety Management Systems</h4>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-3 sm:mb-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-[#140079] mb-3 sm:mb-4">Why Choose Indigo?</h3>
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4 sm:mb-6">
                    ...
                    {/* Conclusion */}
                    <h3 className="text-xl sm:text-2xl font-bold text-[#140079] mb-3 sm:mb-4">Confidence Through Certification</h3>
                ...
                {/* Share Section - Uncommented and made responsive */}
