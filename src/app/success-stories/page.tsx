        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600 mb-4">
              &ldquo;IndigoTG transformed our patient management system, improving efficiency by 40% and enhancing patient satisfaction.&rdquo;
            </p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600 mb-4">
              &ldquo;Their digital banking solution helped us increase customer engagement and reduce operational costs significantly.&rdquo;
            </p>
            <div className="text-sm text-gray-500">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600 mb-4">
              &ldquo;The new platform increased our sales by 150% and provided a seamless shopping experience for our customers.&rdquo;
            </p>
            <div className="text-sm text-gray-500">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600 mb-4">
              &ldquo;Smart factory implementation reduced production time by 25% and improved quality control by 90%.&rdquo;
            </p>
            <div className="text-sm text-gray-500">
