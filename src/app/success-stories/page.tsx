...
const TextParallaxContentExample = () => {
  return (
    <div className="bg-white">
      ...
      >
        <ExampleContent 
          title="Leading Network Infrastructure"
          description="Our engineers work with some of the world's leading brands to create new and better experiences for their customers."
          buttonText="Explore Our Solutions"
        />
      </TextParallaxContent>
      <TextParallaxContent
        imgUrl="/images/success_stories/success_storybg123.jpg"
        subheading="Innovation"
        heading="Driving Digital Transformation"
      >
        <ExampleContent 
          title="Advanced Technology Solutions"
          description="We collaborate with industry leaders to design, build, and optimize cutting-edge network infrastructure that powers the digital future."
          buttonText="Explore Our Solutions"
        />
      </TextParallaxContent>
      <TextParallaxContent
        ...
        heading="Delivering Success Stories"
      >
        <ExampleContent 
          title="Proven Track Record"
          description="Our expertise spans telecommunications, enterprise networks, and infrastructure projects that connect communities and enable growth."
          buttonText="View Case Studies"
        />
      </TextParallaxContent>
      <TextParallaxContent
        imgUrl="/images/success_stories/Digital-Future%20CTA%20bg.png"
        subheading="Partnership"
        heading="Building Tomorrow Together"
      >
        <ExampleContent 
          title="Strategic Partnerships"
          description="We work alongside global brands to create innovative solutions that transform how businesses connect, communicate, and thrive."
