  ...
  useEffect(() => {
    ...
    ScrollTrigger.create({
      ...
      onUpdate: (self) => {
        ...
        if (progress >= 1 && !(introCard as HTMLElement & { contentRevealed?: boolean }).contentRevealed) {
          (introCard as HTMLElement & { contentRevealed?: boolean }).contentRevealed = true;
        ...
        if (progress < 1 && (introCard as HTMLElement & { contentRevealed?: boolean }).contentRevealed) {
          (introCard as HTMLElement & { contentRevealed?: boolean }).contentRevealed = false;
