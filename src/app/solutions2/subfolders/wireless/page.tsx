        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We deliver cutting-edge wireless network solutions including 5G deployment, 
              network upgrades, and innovative network sharing technologies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#140079] mb-4">5G Deployment</h3>
              <p className="text-gray-600">
                Complete 5G network deployment services including site planning, 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#140079] mb-4">Network Upgrades</h3>
              <p className="text-gray-600">
                Seamless network upgrade services from legacy systems to modern 
                wireless technologies with minimal disruption.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#140079] mb-4">Network Sharing</h3>
              <p className="text-gray-600">
                Innovative network sharing solutions that optimize infrastructure 
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-[#140079] mb-6">
                  Why Choose Our Wireless Services?
                </h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Latest 5G technology expertise</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-[#140079] mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-700">Minimal disruption deployments</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-[#140079] mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Future-proof infrastructure</span>
                  </li>
                </ul>
              </div>
