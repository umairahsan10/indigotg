        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#140079] mb-6">
              Comprehensive Fixed Line Solutions
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide end-to-end fixed line infrastructure services to ensure 
              reliable connectivity and maintain the digital backbone of the country.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#140079] mb-4">Network Design</h3>
              <p className="text-gray-600">
                Comprehensive network design and planning services for fixed line 
                infrastructure including fiber optic and copper networks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#140079] mb-4">Installation & Deployment</h3>
              <p className="text-gray-600">
                Professional installation and deployment services for fixed line 
                infrastructure with quality assurance and testing.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#140079] mb-4">Maintenance & Support</h3>
              <p className="text-gray-600">
                Ongoing maintenance and support services to ensure optimal 
                performance and reliability of fixed line infrastructure.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-[#140079] mb-6">
                  Why Choose Our Fixed Line Services?
                </h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">25+ years of industry experience</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-[#140079] mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
