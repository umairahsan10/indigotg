    ...
    <section ref={sectionRef} className="bg-white py-12 sm:py-16 md:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          {/* Left Column - Image */}
          <div className={`flex justify-center transition-all duration-1000 delay-600 mb-8 md:mb-0 ${
            isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16'
          }`}>
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96">
              {/* Thick spinning border behind image */}
              <div className="absolute inset-0 rounded-full -z-10">
                <div className="absolute inset-0 rounded-full border-8 sm:border-12 md:border-16 border-transparent bg-gradient-to-r from-indigo-600 to-indigo-600 animate-spin" 
                     style={{ 
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-white rounded-full border-2 sm:border-3 md:border-4 border-gray-200 -z-5"></div>
              </div>
              ...
              <div className="relative bg-transparent rounded-full w-full h-full flex items-center justify-center z-10">
                <img 
                  ...
                  className={`w-56 h-56 sm:w-72 sm:h-72 md:w-80 md:h-80 object-cover rounded-full transition-all duration-500 ease-out ${getImageClasses()}`}
                />
              </div>
            </div>
          </div>
          ...
          <div className="px-2 sm:px-4 md:px-0">
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-medium text-[#140079] mb-4 sm:mb-6 md:mb-8 transition-all duration-1000 delay-200 font-roboto ${
            ...
            <p className={`text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8 leading-relaxed transition-all duration-1000 delay-400 font-roboto ${
            ...
            <a href="https://www.indigotg.com/careers-service-leavers/" target="_blank" rel="noopener noreferrer">
              <button className={`bg-[#140079] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-medium hover:bg-[#140079]/90 transition-all duration-300 flex items-center gap-2 w-fit font-roboto transition-all duration-1000 delay-800 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
