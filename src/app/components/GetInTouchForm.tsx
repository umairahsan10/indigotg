  ...
  return (
    <div className="animate-fade-in-slide-up">
      <div className="rounded-3xl p-8 lg:p-12 bg-[#140079]">
        <h2 className="text-3xl font-bold text-white mb-2 font-roboto text-center sm:text-left">Get In Touch!</h2>
        <p className="text-white mb-8 font-roboto text-center sm:text-left">
