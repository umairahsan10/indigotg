    ...
    <section className="h-screen bg-white flex items-center justify-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
           ...
           <div ref={videoRef} className="relative video-content">
             <div 
               className={`relative rounded-2xl overflow-hidden video-shadow ${isVideoPlaying ? 'video-playing' : ''}`}
               onMouseEnter={handleVideoHover}
               onMouseLeave={handleVideoLeave}
             >
              <iframe
                src="https://www.youtube.com/embed/qF-GaYki4lA?rel=0&modestbranding=1"
      ...
      <style jsx>{`
        ...
        .video-content.animate-in .relative {
          animation: videoGlow 1.5s ease-out 0.3s both, floating 3s ease-in-out infinite;
        }
        ...
        /* Stop floating when video is playing */
        .video-content .relative.video-playing {
          animation: none;
        }
