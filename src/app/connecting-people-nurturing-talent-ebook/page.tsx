...
import { EbookStackedCards } from "../components/connectingpeopleHRebook";
...
export default function EbookPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    link.href = '/ebook/Indigo HR e-book.pdf';
    link.download = 'Indigo HR eBook.pdf';
    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div style={{position: 'relative', zIndex: 2, maxWidth: '1280px', margin: '0 auto', padding: '64px 16px'}}>
        ...
        <div className="text-center mb-16">
          ...
          <h1 style={{textAlign: 'center', fontSize: '55px'}}><span style={{color: '#140177'}} className="font-bold">Download Your Free eBook</span></h1>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8 relative z-30">
            <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
              <h2 className="text-2xl font-bold" style={{color: '#140177'}}>What's inside?</h2>
              <p>
              ...
              <p>
                We are one Indigo, one team – working with people of different backgrounds, cultures, and thinking styles, helping our people grow into better professionals and leaders. We always treat people with respect and recognise that diversity and inclusion makes us stronger.
              </p>
              <p>
                Our people are the driving force behind our business, and as a growing company we are always looking to expand our talent pool. We are very proud of where we are today and excited for what's to come in the future.
              </p>
          ...
          <div className="flex justify-center lg:justify-end mt-[-12rem] relative z-30">
            <div className="relative">
              ...
              <div className="mt-[-0.5rem] flex justify-center">
                <img 
                  src="/ebook/Indigo HR ebook cover page.webp" 
                  alt="Indigo HR ebook cover" 
